function getContentCSS(codeBoxColor) {
  ...
  return `
    <style>
        ...
        pre{padding: 32px 16px 16px 16px;margin: 15px 0;display: block;line-height: 18px;background: ${codeBoxColor};border-radius: 6px;font-size: 13px; font-family: 'monaco', 'Consolas', "Liberation Mono", Courier, monospace; word-break: break-all; word-wrap: break-word;overflow-x: auto;}
